 ...
 * @class Context
 * @constructor
 * @param {Object} obj source for context
 *
 * */
...
/**
 * says, if the `obj` Context or no
 * @method
 * @for Context
 * @static
 * @param {Object} obj value for checking
 *
 * */
 ...
 *
 * */
Context.prototype.extend=function(addition){
    addition||function(){throw new TypeError('Argument `addition` missed')}();
    if(!Context.isContext(addition)){
        addition=new Context(addition);
    }
    return _.extend({},this,addition);
};
